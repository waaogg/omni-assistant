...
(async () => {
  ...
  await registry.update('wx-user-a', { status: 'active', todoAccountId: 'todo-a', thinkMode: true });
  ...
  if (activeA.thinkMode !== true || stillPendingB.thinkMode === true) process.exit(18);
